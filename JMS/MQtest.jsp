...
<%
	...
	try {
		...
		env.put(javax.naming.Context.PROVIDER_URL, "iiop://tcrea01:9809");

		javax.naming.Context ctx = null;
	
		ctx = new javax.naming.InitialContext(env);
		cf= (javax.jms.ConnectionFactory)ctx.lookup("jms/T_EAI_OB_CRE_QCF");
		System.out.println("CF = " + cf);
		conn = cf.createConnection();
		conn.start();
		dest = (javax.jms.Destination) ctx.lookup("jms/T_EAI_OB_CRE_QUE");
		System.out.println("Qeuee = " + dest);		
		...
		while(true){
			...
			//sb.append("</connector>");
			sb.append("Test Message to MQ queue");
