...
<%@page import="javax.jms.MessageProducer,java.util.*"%>
<html>
<head>
...
<%
	...
	try {
		...
		cf= (javax.jms.ConnectionFactory)ctx.lookup("jms/testQCF");
		conn = cf.createConnection();
		conn.start();
		dest = (javax.jms.Destination) ctx.lookup("jms/testQ");
		...
		while(true){
			...
			sb.append("Test Message for JMS");
